...
const ProjectChatPage: FC = () => {
  ...
  useEffect(() => {
    if (messagesContainerRef.current && query.data?.data?.aiSessions) {
  ...
  if (query.isLoading) {
    return (
      <div className='flex font-semibold text-2xl mt-40 w-full justify-center items-center'>
        Loading...
      </div>
    );
  }
  return (
    <main className='flex flex-col flex-1'>
      ...
      <div className='flex-1   overflow-y-auto  max-w-[1000px] rounded mb-5 mx-auto'>
              ...
              <div className='flex justify-center md:justify-end mt-4'>
                <button
                  ...
                  onClick={() => {
                    ...
                    a.href = url;
                    a.download = `${query.data?.data?.title || "schema"}.json`;
      ...
      <div className='pb-[60px] sticky bottom-0 w-full bg-white '>
              ...
              <>
                ...
                {query.data.data.aiSessions.length > 1 &&
                  ...
                  query.data.data.aiSessions[
                    ...
                    <div className='px-5 py-2.5 bg-[#e8e8e8]/50 rounded-2xl inline-flex justify-center items-center gap-2.5 mb-5 animate-slide-up'>
                ...
                {_.last(query.data.data.aiSessions)?.question && (
                  <div className='px-3 py-2 inline-flex justify-start items-center gap-2.5 animate-slide-up'>
        ...
        <form
          ...
          className='flex justify-center items-center -mx-10 bg-white'
        >
          <InputField
            id='answer'
